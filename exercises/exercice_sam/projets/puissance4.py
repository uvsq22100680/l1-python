...
def afficher(event):
        ...
        if arret_du_jeu == 0 :
                ...
                if Alternance ==True:
                        ...
                        verification_diagonale()
                        manche_nulle()
                        if Possible == True and arret_du_jeu == 0:
                                Alternance = False
                                if couleur == "red":
                                        couleur = "yellow"
...
def jouer(event):
        ...
        global nombre_colonne1,nombre_colonne2,nombre_colonne3,nombre_colonne4,nombre_colonne5,nombre_colonne6,nombre_colonne7,Possible
                ...
                for j in range(6):
                        if matrice[i][j] == matrice[i][j+1] and matrice[i][j+1] != 0 :
                                ...
                                if cpt == 3:
                                        arret_du_jeu+=1
                                        if couleur == "red" :
                                                label_info_gagner.config(text="La partie est gagnée pour le joueur rouge",bg="red")
                                                label_info_jouer.config(text= "LA PARTIE EST TERMINEE")
                                        if couleur == "yellow" :
                                                label_info_gagner.config(text="La partie est gagnée pour le joueur jaune",bg="yellow")
                                                label_info_jouer.config(text= "LA PARTIE EST TERMINEE")
                        else:                                   
                                cpt=0
...
def verification_diagonale():
        global arret_du_jeu
        for i in range(5):
                cpt = 0
                for j in range(6):
                        if matrice[i][j] == matrice[i+1][j+1] and matrice[i+1][j+1] != 0 :
                                cpt+=1
                                if cpt == 3:
                                        arret_du_jeu +=1
                                        if couleur == "red" :
...
def manche_nulle():
        ...
        for i in matrice[0]:
                if i == 1 or 2:
                        ...
                        if len(l) == 7:
                                arret_du_jeu += 1
                                label_info_gagner.config(text="La partie est nulle",bg ="black")
...
label_info_jouer = tk.Label(fenetre,text= "",font = ("helvetica",25))
label_info_gagner = tk.Label(fenetre,text= "",font = ("helvetica",30))
...
bouton_aleatoire.grid(columns=7,row=0)
bouton_quitter.grid(columns=2,row=0)
label_info_jouer.grid(columnspan=7)
label_info_gagner.grid(row=1,column=0,columnspan=7)
